...
public class DataLoader {
    ...
    private void loadData(){
        ...
        // create an author
        Author sly = new Author("Sly","Chan","s.khawar@chello.at");
        authorRepository.save(sly);
    ...
    private void createAuthors() {
        Author jv = new Author("Joey","Zaza","joey@zaza.com");
        authorRepository.save(jv);
        Author av = new Author("Andy","Garcia","andy@garcia.com");
        authorRepository.save(av);
        Author kv = new Author("Katie","Holmes","katie@holmes.com");
